...
- самые рискованные решения уже покрыты permutation-тестами, но большие случайные раскладки все еще стоит прогнать отдельным property/fuzz слоем;
...
Оценка DnD UX после изменений: примерно 8.8/10. Это уже рабочая и приятная база, но в плотных раскладках с несколькими соседями пользователь все еще может увидеть "магическое" решение.
...
Самые приоритетные оставшиеся улучшения: более глубокие permutation/property-тесты, global layout scoring для multi-window carving/push решений и ручная обкатка explicit swap. После этого DnD станет не просто рабочим, а таким, которому начинаешь доверять рукой.
