...
class TilingEngine {
    ...
    static calculateNextState(currentState, direction, config, siblingSpans = []) {
        ...
        if (!nextState.vSpan) {
            nextState.vSpan = exports.VERTICAL_SPANS[nextState.vIndex] || exports.VERTICAL_SPANS[5];
        }
    ...
    static calculateChainTransitions(activeId, direction, config, activeWindows, allVisibleSpans = []) {
        ...
        const normalizedWindows = activeWindows.map(w => {
            ...
            if (!state.vSpan) {
                state.vSpan = exports.VERTICAL_SPANS[state.vIndex] || exports.VERTICAL_SPANS[5];
            }
